...
public class App {
	...
	private static void establishRoutes(Javalin app) {
		...
		Contact cm1 = new Contact("639 Newark Ave.", "Apt. 3L", "Jersey City", "NJ", "07306", "audiolaboratory@hotmail.com", "908-566-7322", "pass");
		cr.addContact(cm1);
		Employee em1 = new Employee("Stuart","Kruze",1000.00,cm1,null);
		emr.addEmployee(em1);
		
		Contact cm2 = new Contact("1220 Arrowood Drive", "", "Jacksonville", "FL", "32216", "KarenERowley@rhyta.com", "904-521-8177", "pass");
		cr.addContact(cm2);
		Employee em2 = new Employee("Karen","Rowley",1000.00,cm2,null);
		emr.addEmployee(em2);
		
		Contact cm3 = new Contact("4656 Lyon Avenue", "", "Hyannis", "MA", "02601", "JeseniaRRamsdell@teleworm.us", "508-957-7850", "pass");
		cr.addContact(cm3);
		Employee em3 = new Employee("Jesenia","Ramsdell",1000.00,cm3,null);
		emr.addEmployee(em3);
		
		Contact cm4 = new Contact("4023 Charack Road", "", "Columbus", "IN", "47201", "DanielFBelanger@rhyta.com", "812-292-9035", "pass");
		cr.addContact(cm4);
		Management mm1 = new Management("Direct Supervisor", true);
		mr.addManagement(mm1);
		Employee em4 = new Employee("Daniel","Belanger",1000.00,cm4,mm1);
		emr.addEmployee(em4);
		
		Contact cm5 = new Contact("2739 Willow Oaks Lane", "", "New Iberia", "LA", "70560", "JohnAGarcia@jourrapide.com", "337-373-6422", "pass");
		cr.addContact(cm5);
		Management mm2 = new Management("Direct Supervisor", false);
		mr.addManagement(mm2);
		Employee em5 = new Employee("John","Garcia",1000.00,cm5,mm2);
		emr.addEmployee(em5);
		
		Contact cm6 = new Contact("4623 Clair Street", "", "Waco", "TX", "76710", "MarilynBShelton@rhyta.com", "254-751-7274", "pass");
		cr.addContact(cm6);
		Management mm3 = new Management("Benefits Coordinator", false);
		mr.addManagement(mm3);
		Employee em6 = new Employee("Marilyn","Shelton",1000.00,cm6,mm3);
		emr.addEmployee(em6);
